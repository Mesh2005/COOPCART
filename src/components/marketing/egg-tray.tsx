...
/**
 * 3D-style studio render of brown eggs (pure SVG): key-light specular
 * highlights, warm reflected bounce light on the shadow side, soft cast
 * shadows and a glossy floor reflection. Gently floats; no external assets.
 */
