    ...
    <div className="relative min-h-dvh">
      ...
      <div className="relative mx-auto flex min-h-dvh w-full max-w-md flex-col justify-center px-5 py-12">
        <Link href="/" className="mb-8 flex items-center gap-2.5 self-center">
          <span className="flex h-10 w-10 items-center justify-center rounded-full bg-brown-600 text-cream">
        ...
        <div className="rounded-3xl border border-line bg-surface p-7 shadow-[0_24px_60px_-35px_rgba(61,42,28,0.5)] sm:p-8">
          {children}
        </div>
      </div>
    </div>
